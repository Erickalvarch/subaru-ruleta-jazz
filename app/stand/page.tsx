...
export default function StandPage() {
  ...
  function drawLabel(ctx: CanvasRenderingContext2D, label: PrizeKey, size: number) {
    // Texto legible: si es largo, lo partimos en 2 líneas
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <div className="aspect-video w-full rounded-3xl bg-white shadow-2xl ring-1 ring-neutral-200 overflow-hidden">
          <div className="h-full w-full grid grid-rows-1">
            <div className="grid grid-cols-12 gap-6 px-8 py-8 items-center h-full">
              {/* izquierda */}
              ...
              <div className="col-span-12 md:col-span-7 flex items-center justify-center">
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  <div className="w-full aspect-square max-h-[84%] max-w-[84%] flex items-center justify-center">
